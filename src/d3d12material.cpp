...
D3D12Material::D3D12Material(ID3D12DevicePtr d3d12Device) : m_device(d3d12Device)
{
    assert(m_device);
...
void D3D12Material::Apply(ID3D12GraphicsCommandListPtr commandList, D3D12_GPU_DESCRIPTOR_HANDLE cbv,
...
D3D12_FEATURE_DATA_ROOT_SIGNATURE D3D12Material::GetFeatureRootSignatureHighestVerSupported()
{
