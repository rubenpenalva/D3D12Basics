...
D3D12DescriptorHeap::D3D12DescriptorHeap(ID3D12DevicePtr d3d12Device, 
                                         D3D12_DESCRIPTOR_HEAP_TYPE type, unsigned int heapSize) : m_d3d12Device(d3d12Device)
{
    ...
    heapDesc.Type           = type;
    heapDesc.Flags          =   type == D3D12_DESCRIPTOR_HEAP_TYPE_RTV || 
                                type == D3D12_DESCRIPTOR_HEAP_TYPE_DSV ? D3D12_DESCRIPTOR_HEAP_FLAG_NONE : D3D12_DESCRIPTOR_HEAP_FLAG_SHADER_VISIBLE;
